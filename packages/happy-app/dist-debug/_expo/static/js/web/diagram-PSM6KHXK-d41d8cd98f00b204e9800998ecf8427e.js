__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var TreeMapDB = (_Class = class TreeMapDB {
    ...
    getConfig() {
      const defaultConfig = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").defaultConfig_default;
      const userConfig = (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").getConfig)();
      return (0, require(_dependencyMap[1], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(Object.assign({}, defaultConfig.treemap, userConfig.treemap ?? {}));
    }
    addNode(node, level) {
    ...
    addClass(id, _style) {
      ...
      if (styles) {
        styles.forEach(s => {
          if ((0, require(_dependencyMap[2], "./chunk-ATLVNIR6.mjs").isLabelStyle)(s)) {
  ...
  }, (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(_Class, "TreeMapDB"), _Class);
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(buildHierarchy, "buildHierarchy");

  // src/diagrams/treemap/parser.ts
  var populate = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((ast, db) => {
    (0, require(_dependencyMap[4], "./chunk-4BX2VUAB.mjs").populateCommonDb)(ast, db);
    const items = [];
    ...
    const addNodesRecursively = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((nodes, level) => {
  ...
  var getItemName = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(item => {
  ...
  var parser = {
    ...
    parse: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async text => {
      try {
        const parseFunc = require(_dependencyMap[5], "@mermaid-js/parser").parse;
        const ast = await parseFunc("treemap", text);
        require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").log.debug("Treemap AST:", ast);
        ...
        require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").log.error("Error parsing treemap:", error);
        throw error;
      }
    }, "parse")
  };
  ...
  var draw = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((_text, id, _version, diagram2) => {
    ...
    const {
      themeVariables
    } = (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").getConfig)();
    if (!root) {
      return;
    }
    const titleHeight = title ? 30 : 0;
    const svg = (0, require(_dependencyMap[6], "./chunk-EXTU4WIE.mjs").selectSvgElement)(id);
    ...
    try {
      ...
      if (formatStr === "$0,0") {
        valueFormat = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(value => "$" + (0, require(_dependencyMap[7], "d3").format)(",")(value), "valueFormat");
      } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
        const precision = /\.\d+/.exec(formatStr);
        const precisionStr = precision ? precision[0] : "";
        valueFormat = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(value => "$" + (0, require(_dependencyMap[7], "d3").format)("," + precisionStr)(value), "valueFormat");
      } else if (formatStr.startsWith("$")) {
        const restOfFormat = formatStr.substring(1);
        valueFormat = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(value => "$" + (0, require(_dependencyMap[7], "d3").format)(restOfFormat || "")(value), "valueFormat");
      } else {
        valueFormat = (0, require(_dependencyMap[7], "d3").format)(formatStr);
      }
    } catch (error) {
      require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").log.error("Error creating format function:", error);
      valueFormat = (0, require(_dependencyMap[7], "d3").format)(",");
    }
    const colorScale = (0, require(_dependencyMap[7], "d3").scaleOrdinal)().range(["transparent", themeVariables.cScale0, themeVariables.cScale1, themeVariables.cScale2, themeVariables.cScale3, themeVariables.cScale4, themeVariables.cScale5, themeVariables.cScale6, themeVariables.cScale7, themeVariables.cScale8, themeVariables.cScale9, themeVariables.cScale10, themeVariables.cScale11]);
    const colorScalePeer = (0, require(_dependencyMap[7], "d3").scaleOrdinal)().range(["transparent", themeVariables.cScalePeer0, themeVariables.cScalePeer1, themeVariables.cScalePeer2, themeVariables.cScalePeer3, themeVariables.cScalePeer4, themeVariables.cScalePeer5, themeVariables.cScalePeer6, themeVariables.cScalePeer7, themeVariables.cScalePeer8, themeVariables.cScalePeer9, themeVariables.cScalePeer10, themeVariables.cScalePeer11]);
    const colorScaleLabel = (0, require(_dependencyMap[7], "d3").scaleOrdinal)().range([themeVariables.cScaleLabel0, themeVariables.cScaleLabel1, themeVariables.cScaleLabel2, themeVariables.cScaleLabel3, themeVariables.cScaleLabel4, themeVariables.cScaleLabel5, themeVariables.cScaleLabel6, themeVariables.cScaleLabel7, themeVariables.cScaleLabel8, themeVariables.cScaleLabel9, themeVariables.cScaleLabel10, themeVariables.cScaleLabel11]);
    if (title) {
    ...
    const hierarchyRoot = (0, require(_dependencyMap[7], "d3").hierarchy)(root).sum(d => d.value ?? 0).sort((a, b) => (b.value ?? 0) - (a.value ?? 0));
    const treemapLayout = (0, require(_dependencyMap[7], "d3").treemap)().size([width, height]).paddingTop(d => d.children && d.children.length > 0 ? SECTION_HEADER_HEIGHT + SECTION_INNER_PADDING : 0).paddingInner(treemapInnerPadding).paddingLeft(d => d.children && d.children.length > 0 ? SECTION_INNER_PADDING : 0).paddingRight(d => d.children && d.children.length > 0 ? SECTION_INNER_PADDING : 0).paddingBottom(d => d.children && d.children.length > 0 ? SECTION_INNER_PADDING : 0).round(true);
    ...
    sections.append("rect").attr("width", d => d.x1 - d.x0).attr("height", d => d.y1 - d.y0).attr("class", (_d, i) => {
      ...
      const styles = (0, require(_dependencyMap[2], "./chunk-ATLVNIR6.mjs").styles2String)({
    ...
    sections.append("text").attr("class", "treemapSectionLabel").attr("x", 6).attr("y", SECTION_HEADER_HEIGHT / 2).attr("dominant-baseline", "middle").text(d => d.depth === 0 ? "" : d.data.name).attr("font-weight", "bold").attr("style", d => {
      ...
      const self = (0, require(_dependencyMap[7], "d3").select)(this);
    ...
    if (config.showValues !== false) {
      ...
      leafValues.each(function (d) {
        const valueTextElement = (0, require(_dependencyMap[7], "d3").select)(this);
        const parentCellNode = this.parentNode;
        if (!parentCellNode) {
          valueTextElement.style("display", "none");
          return;
        }
        const labelElement = (0, require(_dependencyMap[7], "d3").select)(parentCellNode).select(".treemapLabel");
    ...
    (0, require(_dependencyMap[8], "./chunk-QN33PNHL.mjs").setupViewPortForSVG)(svg, diagramPadding, "flowchart", config?.useMaxWidth || false);
  }, "draw");
  var getClasses = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (_text, diagramObj) {
  ...
  var getStyles = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(({
    treemap: treemap2
  } = {}) => {
    const options = (0, require(_dependencyMap[1], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(defaultTreemapStyleOptions, treemap2);
    return `
  .treemapNode.section {
...
},3881,[3872,3882,3852,3854,3916,3917,3871,3884,3902],"../../node_modules/mermaid/dist/chunks/mermaid.core/diagram-PSM6KHXK.mjs");
...
//# debugId=e502f002-b5d2-4f99-9b5a-54593298f7ff