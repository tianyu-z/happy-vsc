__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  require(_dependencyMap[2], "./chunk-CVBHYZKI.mjs");
  require(_dependencyMap[3], "./chunk-ATLVNIR6.mjs");
  require(_dependencyMap[4], "./chunk-JA3XYJ7Z.mjs");
  var khroma = _interopRequireWildcard(require(_dependencyMap[5], "khroma"));
  var _Class; // src/diagrams/flowchart/flowDb.ts
  ...
  var FlowDB = (_Class = class FlowDB {
    // cspell:ignore funs
    constructor() {
      this.vertexCounter = 0;
      this.config = (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)();
      ...
      this.funs = [];
      this.setAccTitle = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").setAccTitle;
      this.setAccDescription = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").setAccDescription;
      this.setDiagramTitle = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").setDiagramTitle;
      this.getAccTitle = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getAccTitle;
      this.getAccDescription = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getAccDescription;
      this.getDiagramTitle = require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getDiagramTitle;
    ...
    sanitizeText(txt) {
      return require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(txt, this.config);
    }
    /**
    ...
    addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
      ...
      if (metadata !== void 0) {
        ...
        doc = (0, require(_dependencyMap[7], "./chunk-MI3HLSF2.mjs").load)(yamlData, {
          schema: require(_dependencyMap[7], "./chunk-MI3HLSF2.mjs").JSON_SCHEMA
        });
      }
      ...
      if (doc !== void 0) {
        if (doc.shape) {
          ...
          } else if (!(0, require(_dependencyMap[8], "./chunk-JZLCHNYA.mjs").isValidShape)(doc.shape)) {
    ...
    addSingleLink(_start, _end, type, id) {
      ...
      require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("abc78 Got edge...", edge);
      ...
      if (id && !this.edges.some(e => e.id === id)) {
        ...
        if (existingLinks.length === 0) {
          edge.id = (0, require(_dependencyMap[10], "./chunk-S3R3BYOJ.mjs").getEdgeId)(edge.start, edge.end, {
            counter: 0,
            prefix: "L"
          });
        } else {
      ...
      if (this.edges.length < (this.config.maxEdges ?? 500)) {
        require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("Pushing edge...");
...
You have to call mermaid.initialize.`);
    ...
    addLink(_start, _end, linkData) {
      ...
      require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("addLink", _start, _end, id);
    ...
    setClickFun(id, functionName, functionArgs) {
      ...
      if ((0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)().securityLevel !== "loose") {
        return;
      }
        ...
        this.funs.push(() => {
          ...
          if (elem !== null) {
            elem.addEventListener("click", () => {
              require(_dependencyMap[10], "./chunk-S3R3BYOJ.mjs").utils_default.runFunc(functionName, ...argList);
            }, false);
          }
        });
      }
    ...
    setLink(ids, linkStr, target) {
      ids.split(",").forEach(id => {
        const vertex = this.vertices.get(id);
        if (vertex !== void 0) {
          vertex.link = require(_dependencyMap[10], "./chunk-S3R3BYOJ.mjs").utils_default.formatUrl(linkStr, this.config);
    ...
    setupToolTips(element) {
      let tooltipElem = (0, require(_dependencyMap[11], "d3").select)(".mermaidTooltip");
      if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
        tooltipElem = (0, require(_dependencyMap[11], "d3").select)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
      }
      const svg = (0, require(_dependencyMap[11], "d3").select)(element).select("svg");
      const nodes = svg.selectAll("g.node");
      nodes.on("mouseover", e => {
        const el = (0, require(_dependencyMap[11], "d3").select)(e.currentTarget);
    ...
    clear(ver = "gen-2") {
      ...
      this.version = ver;
      this.config = (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)();
      (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").clear)();
    }
    setGen(ver) {
    ...
    addSubGraph(_id, list, _title) {
      ...
      const uniq = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(a => {
        const prims = {
          boolean: {},
          number: {},
          string: {}
      ...
      let dir = result.dir;
      const flowchartConfig = (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)().flowchart ?? {};
      dir = dir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)().direction ?? void 0 : void 0);
      ...
      require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
    ...
    addNodeFromVertex(vertex, nodes, parentDB, subGraphDB, config, look) {
      ...
      if (node) {
        ...
        if (isGroup) {
          nodes.push(Object.assign({}, baseNode, {
            isGroup: true,
            shape: "rect"
          }));
        } else {
    ...
    getData() {
      const config = (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)();
      const nodes = [];
      const edges = [];
      ...
      e.forEach((rawEdge, index) => {
        ...
        const edge = {
          id: (0, require(_dependencyMap[10], "./chunk-S3R3BYOJ.mjs").getEdgeId)(rawEdge.start, rawEdge.end, {
            counter: index,
            prefix: "L"
          }, rawEdge.id),
    ...
    defaultConfig() {
      return require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").defaultConfig2.flowchart;
    }
  }, (0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(_Class, "FlowDB"), _Class);

  // src/diagrams/flowchart/flowRenderer-v3-unified.ts

  var getClasses = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (text, diagramObj) {
    return diagramObj.db.getClasses();
  }, "getClasses");
  var draw = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(async function (text, id, _version, diag) {
    require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("REF0:");
    require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.info("Drawing state diagram (v2)", id);
    const {
      securityLevel,
      flowchart: conf,
      layout
    } = (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").getConfig2)();
    let sandboxElement;
    if (securityLevel === "sandbox") {
      sandboxElement = (0, require(_dependencyMap[11], "d3").select)("#i" + id);
    }
    const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
    require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.debug("Before getData: ");
    const data4Layout = diag.db.getData();
    require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.debug("Data: ", data4Layout);
    const svg = (0, require(_dependencyMap[12], "./chunk-55IACEB6.mjs").getDiagramElement)(id, securityLevel);
    const direction = diag.db.getDirection();
    data4Layout.type = diag.type;
    data4Layout.layoutAlgorithm = (0, require(_dependencyMap[13], "./chunk-N4CR4FBY.mjs").getRegisteredLayoutAlgorithm)(layout);
    if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
      require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback.");
    }
    ...
    require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").log.debug("REF1:", data4Layout);
    await (0, require(_dependencyMap[13], "./chunk-N4CR4FBY.mjs").render)(data4Layout, svg);
    const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
    require(_dependencyMap[10], "./chunk-S3R3BYOJ.mjs").utils_default.insertTitle(svg, "flowchartTitleText", conf?.titleTopMargin || 0, diag.db.getDiagramTitle());
    (0, require(_dependencyMap[14], "./chunk-QN33PNHL.mjs").setupViewPortForSVG)(svg, padding, "flowchart", conf?.useMaxWidth || false);
    for (const vertex of data4Layout.nodes) {
      const node = (0, require(_dependencyMap[11], "d3").select)(`#${id} [id="${vertex.id}"]`);
      if (!node || !vertex.link) {
        continue;
      }
  ...
  var parser = function () {
    var o = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (k, v, o2, l) {
    ...
    var parser2 = {
      trace: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function trace() {}, "trace"),
      yy: {},
      symbols_: {
        "error": 2,
        "start": 3,
      ...
      performAction: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
        var $0 = $$.length - 1;
        switch (yystate) {
          case 2:
            this.$ = [];
      ...
      defaultActions: {},
      parseError: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function parseError(str, hash) {
        if (hash.recoverable) {
          this.trace(str);
        } else {
      ...
      parse: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function parse(input) {
        var self = this,
          stack = [0],
          tstack = [],
          vstack = [null],
        ...
        (0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(popStack, "popStack");
        function lex() {
          var token;
        ...
        (0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(lex, "lex");
        var symbol,
          preErrorSymbol,
          state,
          action,
    ...
    var lexer = /* @__PURE__ */function () {
      var lexer2 = {
        ...
        setInput: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (input, yy) {
          this.yy = yy || this.yy || {};
          this._input = input;
        ...
        input: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
        ...
        unput: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (ch) {
          var len = ch.length;
          var lines = ch.split(/(?:\r\n?|\n)/g);
        ...
        more: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
          this._more = true;
          return this;
        }, "more"),
        // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
        reject: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
        ...
        less: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (n) {
          this.unput(this.match.slice(n));
        }, "less"),
        // displays already matched input, i.e. for error messages
        pastInput: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
          var past = this.matched.substr(0, this.matched.length - this.match.length);
          return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
        }, "pastInput"),
        // displays upcoming input, i.e. for error messages
        upcomingInput: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
          var next = this.match;
          if (next.length < 20) {
        ...
        showPosition: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
          var pre = this.pastInput();
          var c = new Array(pre.length + 1).join("-");
          return pre + this.upcomingInput() + "\n" + c + "^";
        }, "showPosition"),
        // test the lexed token: return FALSE when not a match, otherwise return token
        test_match: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function (match, indexed_rule) {
        ...
        next: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function () {
          if (this.done) {
            return this.EOF;
          }
          if (!this._input) {
        ...
        lex: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function lex() {
          var r = this.next();
          if (r) {
            return r;
          } else {
        ...
        begin: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function begin(condition) {
          this.conditionStack.push(condition);
        }, "begin"),
        // pop the previously active lexer condition state off the condition stack
        popState: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function popState() {
        ...
        _currentRules: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function _currentRules() {
        ...
        topState: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function topState(n) {
        ...
        pushState: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function pushState(condition) {
          this.begin(condition);
        }, "pushState"),
        // return the number of states currently on the stack
        stateStackSize: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function stateStackSize() {
          return this.conditionStack.length;
        }, "stateStackSize"),
        options: {},
        performAction: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
    ...
    (0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(Parser, "Parser");
  ...
  var fade = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)((color, opacity) => {
  ...
  var getStyles = /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(options => `.label {
  ...
  ${(0, require(_dependencyMap[15], "./chunk-FMBD7UC4.mjs").getIconStyles)()}
`, "getStyles");
  ...
  var diagram = exports.diagram = {
    ...
    init: /* @__PURE__ */(0, require(_dependencyMap[9], "./chunk-AGHRB4JF.mjs").__name)(cnf => {
      if (!cnf.flowchart) {
        cnf.flowchart = {};
      }
      if (cnf.layout) {
        (0, require(_dependencyMap[6], "./chunk-ABZYJK2D.mjs").setConfig2)({
          layout: cnf.layout
        });
      }
...
},3856,[3848,3849,3851,3852,3888,3900,3872,3883,3850,3854,3882,3884,3901,3887,3902,3903],"../../node_modules/mermaid/dist/chunks/mermaid.core/flowDiagram-NV44I4VS.mjs");
...
//# debugId=38a0bce8-3049-43cd-be54-55f418d9cec1