__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var _cytoscape = _interopRequireDefault(require(_dependencyMap[1], "cytoscape"));
  var _cytoscapeFcose = _interopRequireDefault(require(_dependencyMap[2], "cytoscape-fcose"));
  var _Class; // src/diagrams/architecture/architectureParser.ts
  ...
  var ArchitectureDirectionArrow = {
    L: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(scale => `${scale},${scale / 2} 0,${scale} 0,0`, "L"),
    R: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(scale => `0,${scale / 2} ${scale},0 ${scale},${scale}`, "R"),
    T: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(scale => `0,0 ${scale},0 ${scale / 2},${scale}`, "T"),
    B: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(scale => `${scale / 2},0 ${scale},${scale} 0,${scale}`, "B")
  };
  var ArchitectureDirectionArrowShift = {
    L: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((orig, arrowSize) => orig - arrowSize + 2, "L"),
    R: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((orig, _arrowSize) => orig - 2, "R"),
    T: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((orig, arrowSize) => orig - arrowSize + 2, "T"),
    B: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((orig, _arrowSize) => orig - 2, "B")
  };
  var getOppositeArchitectureDirection = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
  ...
  var isArchitectureDirection = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    const temp = x;
    return temp === "L" || temp === "R" || temp === "T" || temp === "B";
  }, "isArchitectureDirection");
  var isArchitectureDirectionX = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    const temp = x;
    return temp === "L" || temp === "R";
  }, "isArchitectureDirectionX");
  var isArchitectureDirectionY = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    const temp = x;
    return temp === "T" || temp === "B";
  }, "isArchitectureDirectionY");
  var isArchitectureDirectionXY = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (a, b) {
    const aX_bY = isArchitectureDirectionX(a) && isArchitectureDirectionY(b);
    const aY_bX = isArchitectureDirectionY(a) && isArchitectureDirectionX(b);
    return aX_bY || aY_bX;
  }, "isArchitectureDirectionXY");
  var isArchitecturePairXY = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (pair) {
    const lhs = pair[0];
    const rhs = pair[1];
  ...
  var isValidArchitectureDirectionPair = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    return x !== "LL" && x !== "RR" && x !== "TT" && x !== "BB";
  }, "isValidArchitectureDirectionPair");
  var getArchitectureDirectionPair = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (sourceDir, targetDir) {
    const pair = `${sourceDir}${targetDir}`;
    return isValidArchitectureDirectionPair(pair) ? pair : void 0;
  }, "getArchitectureDirectionPair");
  var shiftPositionByArchitectureDirectionPair = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function ([x, y], pair) {
    const lhs = pair[0];
    const rhs = pair[1];
  ...
  var getArchitectureDirectionXYFactors = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (pair) {
    if (pair === "LT" || pair === "TL") {
      return [1, 1];
  ...
  var getArchitectureDirectionAlignment = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (a, b) {
  ...
  var isArchitectureService = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    const temp = x;
    return temp.type === "service";
  }, "isArchitectureService");
  var isArchitectureJunction = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (x) {
    const temp = x;
    return temp.type === "junction";
  }, "isArchitectureJunction");
  var edgeData = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(edge => {
    return edge.data();
  }, "edgeData");
  var nodeData = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(node => {
    return node.data();
  }, "nodeData");

  // src/diagrams/architecture/architectureDb.ts
  var DEFAULT_ARCHITECTURE_CONFIG = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").defaultConfig_default.architecture;
  var ArchitectureDB = (_Class = class ArchitectureDB {
    constructor() {
      ...
      this.registeredIds = {};
      this.elements = {};
      this.setAccTitle = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").setAccTitle;
      this.getAccTitle = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getAccTitle;
      this.setDiagramTitle = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").setDiagramTitle;
      this.getDiagramTitle = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getDiagramTitle;
      this.getAccDescription = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getAccDescription;
      this.setAccDescription = require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").setAccDescription;
      this.clear();
    }
    clear() {
      this.nodes = {};
      ...
      this.elements = {};
      (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").clear)();
    }
    addService({
      id,
      icon,
    ...
    getDataStructures() {
      if (this.dataStructures === void 0) {
        ...
        const notVisited = Object.keys(adjList).reduce((prev, id) => id === firstId ? prev : Object.assign({}, prev, {
          [id]: 1
        }), {});
        const BFS = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(startingId => {
          const spatialMap = {
            [startingId]: [0, 0]
          };
    ...
    getConfig() {
      return (0, require(_dependencyMap[5], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(Object.assign({}, DEFAULT_ARCHITECTURE_CONFIG, (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getConfig)().architecture));
    }
    getConfigField(field) {
      return this.getConfig()[field];
    }
  }, (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(_Class, "ArchitectureDB"), _Class);

  // src/diagrams/architecture/architectureParser.ts
  var populateDb = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((ast, db) => {
    (0, require(_dependencyMap[6], "./chunk-4BX2VUAB.mjs").populateCommonDb)(ast, db);
    ast.groups.map(group => db.addGroup(group));
    ast.services.map(service => db.addService(Object.assign({}, service, {
      type: "service"
    })));
    ast.junctions.map(service => db.addJunction(Object.assign({}, service, {
      type: "junction"
    })));
  ...
  var parser = {
    ...
    parse: /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async input => {
      const ast = await (0, require(_dependencyMap[7], "@mermaid-js/parser").parse)("architecture", input);
      require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").log.debug(ast);
  ...
  var getStyles = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(options => `
  .edge {
...
`, "getStyles");
  ...
  var wrapIcon = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(icon => {
  ...
  var architectureIcons = {
    ...
    icons: {
      ...
      unknown: require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").unknownIcon,
      blank: {
        body: wrapIcon("")
      }
    }
  ...
  var drawEdges = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async function (edgesEl, cy, db) {
    ...
    await Promise.all(cy.edges().map(async edge => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", (0, require(_dependencyMap[5], "./chunk-S3R3BYOJ.mjs").getEdgeId)(source, target, {
          prefix: "L"
        }));
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").createText)(textElem, label, {
            useHtmlLabels: false,
            width,
            classes: "architecture-service-label"
          }, (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getConfig2)());
  ...
  var drawGroups = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async function (groupsEl, cy, db) {
    const padding = db.getConfigField("padding");
    ...
    await Promise.all(cy.nodes().map(async node => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(`<g>${await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").getIconSVG)(data.icon, {
        ...
        if (data.label) {
          ...
          await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").createText)(textElem, data.label, {
            useHtmlLabels: false,
            width: w,
            classes: "architecture-service-label"
          }, (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getConfig2)());
  ...
  var drawServices = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async function (db, elem, services) {
    const config = (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").getConfig2)();
    for (const service of services) {
      const serviceElem = elem.append("g");
      const iconSize = db.getConfigField("iconSize");
      if (service.title) {
        const textElem = serviceElem.append("g");
        await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").createText)(textElem, service.title, {
          useHtmlLabels: false,
          width: iconSize * 1.5,
          classes: "architecture-service-label"
        }, config);
      ...
      if (service.icon) {
        bkgElem.html(`<g>${await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").getIconSVG)(service.icon, {
          height: iconSize,
          width: iconSize,
          fallbackPrefix: architectureIcons.prefix
        })}</g>`);
      } else if (service.iconText) {
        bkgElem.html(`<g>${await (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").getIconSVG)("blank", {
          height: iconSize,
          width: iconSize,
          fallbackPrefix: architectureIcons.prefix
        })}</g>`);
        ...
        const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").sanitizeText)(service.iconText, config));
  ...
  var drawJunctions = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(function (db, elem, junctions) {
  ...
  // src/diagrams/architecture/architectureRenderer.ts
  (0, require(_dependencyMap[8], "./chunk-JA3XYJ7Z.mjs").registerIconPacks)([{
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(addServices, "addServices");
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(addJunctions, "addJunctions");
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(positionNodes, "positionNodes");
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(addGroups, "addGroups");
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(addEdges, "addEdges");
  function getAlignments(db, spatialMaps, groupAlignments) {
    const flattenAlignments = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)((alignmentObj, alignmentDir) => {
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(getAlignments, "getAlignments");
  function getRelativeConstraints(spatialMaps, db) {
    const relativeConstraints = [];
    const posToStr = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(pos => `${pos[0]},${pos[1]}`, "posToStr");
    const strToPos = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(pos => pos.split(",").map(p => parseInt(p)), "strToPos");
  ...
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(getRelativeConstraints, "getRelativeConstraints");
  function layoutArchitecture(services, junctions, groups, edges, db, {
    spatialMaps,
    groupAlignments
  }) {
    return new Promise(resolve => {
      const renderEl = (0, require(_dependencyMap[9], "d3").select)("body").append("div").attr("id", "cy").attr("style", "display:none");
      const cy = (0, _cytoscape.default)({
      ...
      layout.one("layoutstop", () => {
        ...
        (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(getSegmentWeights, "getSegmentWeights");
        cy.startBatch();
      ...
      layout.run();
      cy.ready(e => {
        require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").log.info("Ready", e);
        resolve(cy);
      });
    });
  }
  (0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(layoutArchitecture, "layoutArchitecture");
  var draw = /* @__PURE__ */(0, require(_dependencyMap[3], "./chunk-AGHRB4JF.mjs").__name)(async (text, id, _version, diagObj) => {
    const db = diagObj.db;
    ...
    const svg = (0, require(_dependencyMap[10], "./chunk-EXTU4WIE.mjs").selectSvgElement)(id);
    ...
    positionNodes(db, cy);
    (0, require(_dependencyMap[4], "./chunk-ABZYJK2D.mjs").setupGraphViewbox)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
  }, "draw");
  var renderer = {
    draw
  };
...
},3880,[10,3914,4119,3854,3872,3882,3916,3917,3888,3884,3871],"../../node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-VXUJARFQ.mjs");
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  (function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object') module.exports = factory(require(_dependencyMap[0], "cose-base"));else if (typeof define === 'function' && define.amd) define(["cose-base"], factory);else if (typeof exports === 'object') exports["cytoscapeFcose"] = factory(require(_dependencyMap[0], "cose-base"));else root["cytoscapeFcose"] = factory(root["coseBase"]);
...
},4119,[4120],"../../node_modules/cytoscape-fcose/cytoscape-fcose.js");
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  (function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === 'object' && typeof module === 'object') module.exports = factory(require(_dependencyMap[0], "layout-base"));else if (typeof define === 'function' && define.amd) define(["layout-base"], factory);else if (typeof exports === 'object') exports["coseBase"] = factory(require(_dependencyMap[0], "layout-base"));else root["coseBase"] = factory(root["layoutBase"]);
...
},4120,[4121],"../../node_modules/cytoscape-fcose/node_modules/cose-base/cose-base.js");
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  (function webpackUniversalModuleDefinition(root, factory) {
...
},4121,[],"../../node_modules/cytoscape-fcose/node_modules/layout-base/layout-base.js");
...
//# debugId=9ac94789-6d11-48fa-a861-0d34a533494f