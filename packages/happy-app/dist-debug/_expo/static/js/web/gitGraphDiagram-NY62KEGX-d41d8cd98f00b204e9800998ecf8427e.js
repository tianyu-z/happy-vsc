__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var DEFAULT_GITGRAPH_CONFIG = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").defaultConfig_default.gitGraph;
  var getConfig3 = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => {
    const config = (0, require(_dependencyMap[2], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(Object.assign({}, DEFAULT_GITGRAPH_CONFIG, (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").getConfig)().gitGraph));
    return config;
  }, "getConfig");
  var state = new (require(_dependencyMap[3], "./chunk-QZHKN3VN.mjs").ImperativeState)(() => {
  ...
  function getID() {
    return (0, require(_dependencyMap[2], "./chunk-S3R3BYOJ.mjs").random)({
      length: 7
    });
  }
  (0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(getID, "getID");
  ...
  (0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(uniqBy, "uniqBy");
  var setDirection = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (dir2) {
    state.records.direction = dir2;
  }, "setDirection");
  var setOptions = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (rawOptString) {
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("options str", rawOptString);
    rawOptString = rawOptString?.trim();
    rawOptString = rawOptString || "{}";
    try {
      state.records.options = JSON.parse(rawOptString);
    } catch (e) {
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.error("error while parsing gitGraph options", e.message);
    }
  }, "setOptions");
  var getOptions = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    return state.records.options;
  }, "getOptions");
  var commit = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (commitDB) {
    let msg = commitDB.msg;
    let id = commitDB.id;
    const type = commitDB.type;
    let tags = commitDB.tags;
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.info("commit", msg, id, type, tags);
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("Entering commit:", msg, id, type, tags);
    const config = getConfig3();
    id = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(id, config);
    msg = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(msg, config);
    tags = tags?.map(tag => require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(tag, config));
    const newCommit = {
    ...
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.info("main branch", config.mainBranchName);
    if (state.records.commits.has(newCommit.id)) {
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.warn(`Commit ID ${newCommit.id} already exists`);
    }
    state.records.commits.set(newCommit.id, newCommit);
    state.records.branches.set(state.records.currBranch, newCommit.id);
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("in pushCommit " + newCommit.id);
  }, "commit");
  var branch = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (branchDB) {
    let name = branchDB.name;
    const order = branchDB.order;
    name = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(name, getConfig3());
    ...
    checkout(name);
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("in createBranch");
  }, "branch");
  var merge = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(mergeDB => {
    let otherBranch = mergeDB.branch;
    let customId = mergeDB.id;
    const overrideType = mergeDB.type;
    const customTags = mergeDB.tags;
    const config = getConfig3();
    otherBranch = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(otherBranch, config);
    if (customId) {
      customId = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(customId, config);
    }
    ...
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(state.records.branches);
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("in mergeBranch");
  }, "merge");
  var cherryPick = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (cherryPickDB) {
    let sourceId = cherryPickDB.id;
    let targetId = cherryPickDB.targetId;
    let tags = cherryPickDB.tags;
    let parentCommitId = cherryPickDB.parent;
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("Entering cherryPick:", sourceId, targetId, tags);
    const config = getConfig3();
    sourceId = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(sourceId, config);
    targetId = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(targetId, config);
    tags = tags?.map(tag => require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(tag, config));
    parentCommitId = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(parentCommitId, config);
    ...
    if (!targetId || !state.records.commits.has(targetId)) {
      ...
      state.records.branches.set(state.records.currBranch, commit2.id);
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(state.records.branches);
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("in cherryPick");
    }
  }, "cherryPick");
  var checkout = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (branch2) {
    branch2 = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").common_default.sanitizeText(branch2, getConfig3());
  ...
  (0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(upsert, "upsert");
  function prettyPrintCommitHistory(commitArr) {
    ...
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(label.join(" "));
  ...
  (0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(prettyPrintCommitHistory, "prettyPrintCommitHistory");
  var prettyPrint = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(state.records.commits);
    const node = getCommitsArray()[0];
    prettyPrintCommitHistory([node]);
  }, "prettyPrint");
  var clear2 = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    state.reset();
    (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").clear)();
  }, "clear");
  var getBranchesAsObjArray = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    const branchesArray = [...state.records.branchConfig.values()].map((branchConfig, i) => {
      ...
      return Object.assign({}, branchConfig, {
  ...
  var getBranches = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    return state.records.branches;
  }, "getBranches");
  var getCommits = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    return state.records.commits;
  }, "getCommits");
  var getCommitsArray = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    const commitArr = [...state.records.commits.values()];
    commitArr.forEach(function (o) {
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(o.id);
    });
    commitArr.sort((a, b) => a.seq - b.seq);
    return commitArr;
  }, "getCommitsArray");
  var getCurrentBranch = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    return state.records.currBranch;
  }, "getCurrentBranch");
  var getDirection = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
    return state.records.direction;
  }, "getDirection");
  var getHead = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function () {
  ...
  // src/diagrams/git/gitGraphParser.ts
  var populate = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((ast, db2) => {
    (0, require(_dependencyMap[4], "./chunk-4BX2VUAB.mjs").populateCommonDb)(ast, db2);
    if (ast.dir) {
  ...
  var parseStatement = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((statement, db2) => {
    const parsers = {
      Commit: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(stmt => db2.commit(parseCommit(stmt)), "Commit"),
      Branch: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(stmt => db2.branch(parseBranch(stmt)), "Branch"),
      Merge: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(stmt => db2.merge(parseMerge(stmt)), "Merge"),
      Checkout: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(stmt => db2.checkout(parseCheckout(stmt)), "Checkout"),
      CherryPicking: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(stmt => db2.cherryPick(parseCherryPicking(stmt)), "CherryPicking")
    };
    const parser2 = parsers[statement.$type];
    if (parser2) {
      parser2(statement);
    } else {
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.error(`Unknown statement type: ${statement.$type}`);
    }
  }, "parseStatement");
  var parseCommit = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(commit2 => {
    const commitDB = {
      id: commit2.id,
      msg: commit2.message ?? "",
  ...
  var parseBranch = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(branch2 => {
    const branchDB = {
      name: branch2.name,
  ...
  var parseMerge = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(merge2 => {
    const mergeDB = {
  ...
  var parseCheckout = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(checkout2 => {
    const branch2 = checkout2.branch;
    return branch2;
  }, "parseCheckout");
  var parseCherryPicking = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(cherryPicking => {
    const cherryPickDB = {
      id: cherryPicking.id,
      targetId: "",
  ...
  var parser = {
    parse: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(async input => {
      const ast = await (0, require(_dependencyMap[5], "@mermaid-js/parser").parse)("gitGraph", input);
  ...
  var DEFAULT_CONFIG = (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").getConfig2)();
  ...
  var maxPos = 0;
  var dir = "LR";
  var clear3 = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => {
    branchPos.clear();
    commitPos.clear();
  ...
  var drawText = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(txt => {
  ...
  var findClosestParent = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(parents => {
    let closestParent;
    let comparisonFunc;
    let targetPosition;
    if (dir === "BT") {
      comparisonFunc = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((a, b) => a <= b, "comparisonFunc");
  ...
  var findClosestParentBT = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(parents => {
    let closestParent = "";
  ...
  var setParallelBTPos = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((sortedKeys, commits, defaultPos2) => {
  ...
  var findClosestParentPos = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(commit2 => {
  ...
  var calculateCommitPosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(commit2 => {
    const closestParentPos = findClosestParentPos(commit2);
    return closestParentPos + COMMIT_STEP;
  }, "calculateCommitPosition");
  var setCommitPosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((commit2, curPos) => {
  ...
  var setRootPosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((commit2, curPos, defaultPos2) => {
    const branch2 = branchPos.get(commit2.branch);
    if (!branch2) {
      throw new Error(`Branch not found for commit ${commit2.id}`);
    }
  ...
  var drawCommitBullet = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
  ...
  var drawCommitLabel = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((gLabels, commit2, commitPosition, pos) => {
  ...
  var drawCommitTags = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((gLabels, commit2, commitPosition, pos) => {
  ...
  var getCommitClassType = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(commit2 => {
  ...
  var calculatePosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((commit2, dir2, pos, commitPos2) => {
  ...
  var getCommitPosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((commit2, pos, isParallelCommits) => {
  ...
  var drawCommits = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((svg, commits, modifyGraph) => {
    ...
    const sortKeys = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((a, b) => {
  ...
  var shouldRerouteArrow = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((commitA, commitB, p1, p2, allCommits) => {
    const commitBIsFurthest = dir === "TB" || dir === "BT" ? p1.x < p2.x : p1.y < p2.y;
    const branchToGetCurve = commitBIsFurthest ? commitB.branch : commitA.branch;
    const isOnBranchToGetCurve = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(x => x.branch === branchToGetCurve, "isOnBranchToGetCurve");
    const isBetweenCommits = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(x => x.seq > commitA.seq && x.seq < commitB.seq, "isBetweenCommits");
    return [...allCommits.values()].some(commitX => {
      return isBetweenCommits(commitX) && isOnBranchToGetCurve(commitX);
    });
  }, "shouldRerouteArrow");
  var findLane = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((y1, y2, depth = 0) => {
  ...
  var drawArrow = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((svg, commitA, commitB, allCommits) => {
  ...
  var drawArrows = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((svg, commits) => {
  ...
  var drawBranches = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((svg, branches) => {
  ...
  var setBranchPosition = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (name, pos, index, bbox, rotateCommitLabel) {
    branchPos.set(name, {
      pos,
      index
    });
  ...
  var draw = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(function (txt, id, ver, diagObj) {
    clear3();
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
    if (!DEFAULT_GITGRAPH_CONFIG2) {
      throw new Error("GitGraph config not found");
    }
    ...
    const diagram2 = (0, require(_dependencyMap[6], "d3").select)(`[id="${id}"]`);
    let pos = 0;
    branches.forEach((branch2, index) => {
    ...
    require(_dependencyMap[2], "./chunk-S3R3BYOJ.mjs").utils_default.insertTitle(diagram2, "gitTitleText", DEFAULT_GITGRAPH_CONFIG2.titleTopMargin ?? 0, db2.getDiagramTitle());
    (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").setupGraphViewbox2)(void 0, diagram2, DEFAULT_GITGRAPH_CONFIG2.diagramPadding, DEFAULT_GITGRAPH_CONFIG2.useMaxWidth);
  }, "draw");
  ...
  if (void 0) {
    ...
    describe("branchPosition", () => {
      const bbox = {
        ...
        bottom: 0,
        left: 0,
        toJSON: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => "", "toJSON")
      };
  ...
  var getStyles = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(options => `
  .commit-id,
  .commit-msg,
  .branch-label {
    fill: lightgrey;
...
},3858,[3872,3854,3882,3915,3916,3917,3884],"../../node_modules/mermaid/dist/chunks/mermaid.core/gitGraphDiagram-NY62KEGX.mjs");
...
//# debugId=9fe1f0f2-eb5b-4c8e-966c-152e748b92a7