__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var _Class, _Class2, _Class3, _Class4, _Class5, _Class6, _Class7, _Class8, _Class9, _Class0;
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(isBarPlot, "isBarPlot");
  function isBandAxisData(data) {
    return data.type === "band";
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(isBandAxisData, "isBandAxisData");
  function isLinearAxisData(data) {
    return data.type === "linear";
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(isLinearAxisData, "isLinearAxisData");

  // src/diagrams/xychart/chartBuilder/textDimensionCalculator.ts
  var TextDimensionCalculatorWithFont = (_Class = class TextDimensionCalculatorWithFont {
    ...
    getMaxDimension(texts, fontSize) {
      ...
      for (const t of texts) {
        const bbox = (0, require(_dependencyMap[1], "./chunk-JA3XYJ7Z.mjs").computeDimensionOfText)(elem, 1, t);
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class, "TextDimensionCalculatorWithFont"), _Class);
  ...
  var BaseAxis = (_Class2 = class BaseAxis {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class2, "BaseAxis"), _Class2);

  // src/diagrams/xychart/chartBuilder/components/axis/bandAxis.ts
  var BandAxis = (_Class3 = class BandAxis extends BaseAxis {
    constructor(axisConfig, axisThemeConfig, categories, title, textDimensionCalculator) {
      super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
      this.categories = categories;
      this.scale = (0, require(_dependencyMap[2], "d3").scaleBand)().domain(this.categories).range(this.getRange());
    }
    setRange(range) {
      super.setRange(range);
    }
    recalculateScale() {
      this.scale = (0, require(_dependencyMap[2], "d3").scaleBand)().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5);
      require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
    }
    getTickValues() {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class3, "BandAxis"), _Class3);

  // src/diagrams/xychart/chartBuilder/components/axis/linearAxis.ts

  var LinearAxis = (_Class4 = class LinearAxis extends BaseAxis {
    constructor(axisConfig, axisThemeConfig, domain, title, textDimensionCalculator) {
      super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
      this.domain = domain;
      this.scale = (0, require(_dependencyMap[2], "d3").scaleLinear)().domain(this.domain).range(this.getRange());
    }
    getTickValues() {
    ...
    recalculateScale() {
      ...
      this.scale = (0, require(_dependencyMap[2], "d3").scaleLinear)().domain(domain).range(this.getRange());
    }
    getScaleValue(value) {
      return this.scale(value);
    }
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class4, "LinearAxis"), _Class4);
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getAxis, "getAxis");

  // src/diagrams/xychart/chartBuilder/components/chartTitle.ts
  var ChartTitle = (_Class5 = class ChartTitle {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class5, "ChartTitle"), _Class5);
  function getChartTitleComponent(chartConfig, chartData, chartThemeConfig, tmpSVGGroup2) {
    const textDimensionCalculator = new TextDimensionCalculatorWithFont(tmpSVGGroup2);
    return new ChartTitle(textDimensionCalculator, chartConfig, chartData, chartThemeConfig);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartTitleComponent, "getChartTitleComponent");

  // src/diagrams/xychart/chartBuilder/components/plot/linePlot.ts

  var LinePlot = (_Class6 = class LinePlot {
    ...
    getDrawableElement() {
      ...
      if (this.orientation === "horizontal") {
        path = (0, require(_dependencyMap[2], "d3").line)().y(d => d[0]).x(d => d[1])(finalData);
      } else {
        path = (0, require(_dependencyMap[2], "d3").line)().x(d => d[0]).y(d => d[1])(finalData);
      }
      if (!path) {
        return [];
      }
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class6, "LinePlot"), _Class6);

  // src/diagrams/xychart/chartBuilder/components/plot/barPlot.ts
  var BarPlot = (_Class7 = class BarPlot {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class7, "BarPlot"), _Class7);

  // src/diagrams/xychart/chartBuilder/components/plot/index.ts
  var BasePlot = (_Class8 = class BasePlot {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class8, "BasePlot"), _Class8);
  function getPlotComponent(chartConfig, chartData, chartThemeConfig) {
    return new BasePlot(chartConfig, chartData, chartThemeConfig);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getPlotComponent, "getPlotComponent");

  // src/diagrams/xychart/chartBuilder/orchestrator.ts
  var Orchestrator = (_Class9 = class Orchestrator {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class9, "Orchestrator"), _Class9);

  // src/diagrams/xychart/chartBuilder/index.ts
  var XYChartBuilder = (_Class0 = class XYChartBuilder {
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class0, "XYChartBuilder"), _Class0);
  ...
  function getChartDefaultThemeConfig() {
    const defaultThemeVariables = (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getThemeVariables)();
    const config = (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getConfig)();
    return (0, require(_dependencyMap[4], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
  function getChartDefaultConfig() {
    const config = (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getConfig)();
    return (0, require(_dependencyMap[4], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").defaultConfig_default.xyChart, config.xyChart);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartDefaultConfig, "getChartDefaultConfig");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartDefaultData, "getChartDefaultData");
  function textSanitizer(text) {
    const config = (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getConfig)();
    return (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").sanitizeText)(text.trim(), config);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(textSanitizer, "textSanitizer");
  function setTmpSVGG(SVGG) {
    tmpSVGGroup = SVGG;
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setTmpSVGG, "setTmpSVGG");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setOrientation, "setOrientation");
  function setXAxisTitle(title) {
    xyChartData.xAxis.title = textSanitizer(title.text);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setXAxisTitle, "setXAxisTitle");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setXAxisRangeData, "setXAxisRangeData");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setXAxisBand, "setXAxisBand");
  function setYAxisTitle(title) {
    xyChartData.yAxis.title = textSanitizer(title.text);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setYAxisTitle, "setYAxisTitle");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setYAxisRangeData, "setYAxisRangeData");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setYAxisRangeFromPlotData, "setYAxisRangeFromPlotData");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(transformDataWithoutCategory, "transformDataWithoutCategory");
  function getPlotColorFromPalette(plotIndex2) {
    return plotColorPalette[plotIndex2 === 0 ? 0 : plotIndex2 % plotColorPalette.length];
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getPlotColorFromPalette, "getPlotColorFromPalette");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setLineData, "setLineData");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setBarData, "setBarData");
  function getDrawableElem() {
    if (xyChartData.plots.length === 0) {
      throw Error("No Plot to render, please provide a plot with some data");
    }
    xyChartData.title = (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getDiagramTitle)();
    return XYChartBuilder.build(xyChartConfig, xyChartData, xyChartThemeConfig, tmpSVGGroup);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getDrawableElem, "getDrawableElem");
  function getChartThemeConfig() {
    return xyChartThemeConfig;
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartThemeConfig, "getChartThemeConfig");
  function getChartConfig() {
    return xyChartConfig;
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getChartConfig, "getChartConfig");
  function getXYChartData() {
    return xyChartData;
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getXYChartData, "getXYChartData");
  var clear2 = /* @__PURE__ */(0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(function () {
    (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").clear)();
    plotIndex = 0;
  ...
  var xychartDb_default = {
    getDrawableElem,
    clear: clear2,
    setAccTitle: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").setAccTitle,
    getAccTitle: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getAccTitle,
    setDiagramTitle: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").setDiagramTitle,
    getDiagramTitle: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getDiagramTitle,
    getAccDescription: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").getAccDescription,
    setAccDescription: require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").setAccDescription,
    setOrientation,
    setXAxisTitle,
    setXAxisRangeData,
    setXAxisBand,
  ...
  var draw = /* @__PURE__ */(0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)((txt, id, _version, diagObj) => {
    const db = diagObj.db;
    ...
    (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getDominantBaseLine, "getDominantBaseLine");
    function getTextAnchor(verticalPos) {
      return verticalPos === "left" ? "start" : verticalPos === "right" ? "end" : "middle";
    }
    (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getTextAnchor, "getTextAnchor");
    function getTextTransformation(data) {
      return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
    }
    (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getTextTransformation, "getTextTransformation");
    require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.debug("Rendering xychart chart\n" + txt);
    ...
    (0, require(_dependencyMap[3], "./chunk-ABZYJK2D.mjs").configureSvgSize)(svg, chartConfig.height, chartConfig.width, true);
    ...
    (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getGroup, "getGroup");
        ...
        case "rect":
          ...
          if (chartConfig.showDataLabel) {
            if (chartConfig.chartOrientation === "horizontal") {
              ...
              (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(fitsHorizontally2, "fitsHorizontally");
              ...
              (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(fitsInBar2, "fitsInBar");
              const yOffset = 10;
              const validItems = shape.data.map((d, i) => ({
                data: d,
                label: labelData[i].toString()
...
},3863,[3854,3888,3884,3872,3882,3871],"../../node_modules/mermaid/dist/chunks/mermaid.core/xychartDiagram-PRI3JC2R.mjs");
...
//# debugId=33531573-c861-48e1-9a71-ec0fcf139981