__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var defaultThemeVariables = (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").getThemeVariables)();
  var QuadrantBuilder = (_Class = class QuadrantBuilder {
    constructor() {
    ...
    getDefaultConfig() {
      return {
        ...
        showYAxis: true,
        showTitle: true,
        chartHeight: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.chartWidth || 500,
        chartWidth: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.chartHeight || 500,
        titlePadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.titlePadding || 10,
        titleFontSize: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.titleFontSize || 20,
        quadrantPadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.quadrantPadding || 5,
        xAxisLabelPadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.xAxisLabelPadding || 5,
        yAxisLabelPadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.yAxisLabelPadding || 5,
        xAxisLabelFontSize: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.xAxisLabelFontSize || 16,
        yAxisLabelFontSize: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.yAxisLabelFontSize || 16,
        quadrantLabelFontSize: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.quadrantLabelFontSize || 16,
        quadrantTextTopPadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.quadrantTextTopPadding || 5,
        pointTextPadding: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.pointTextPadding || 5,
        pointLabelFontSize: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.pointLabelFontSize || 12,
        pointRadius: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.pointRadius || 5,
        xAxisPosition: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.xAxisPosition || "top",
        yAxisPosition: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.yAxisPosition || "left",
        quadrantInternalBorderStrokeWidth: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
        quadrantExternalBorderStrokeWidth: require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").defaultConfig_default.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
      };
    }
    ...
    clear() {
      ...
      this.data = this.getDefaultData();
      this.classes = /* @__PURE__ */new Map();
      require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.info("clear called");
    }
    setData(data) {
    ...
    setConfig(config2) {
      require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.trace("setConfig called with: ", config2);
      this.config = Object.assign({}, this.config, config2);
    }
    setThemeConfig(themeConfig) {
      require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.trace("setThemeConfig called with: ", themeConfig);
      this.themeConfig = Object.assign({}, this.themeConfig, themeConfig);
    }
    ...
    getQuadrantPoints(spaceData) {
      ...
      const xAxis = (0, require(_dependencyMap[2], "d3").scaleLinear)().domain([0, 1]).range([quadrantLeft, quadrantWidth + quadrantLeft]);
      const yAxis = (0, require(_dependencyMap[2], "d3").scaleLinear)().domain([0, 1]).range([quadrantHeight + quadrantTop, quadrantTop]);
      const points = this.data.points.map(point => {
        const classStyles = this.classes.get(point.className);
        if (classStyles) {
          point = Object.assign({}, classStyles, point);
        }
        const props = {
          x: xAxis(point.x),
          y: yAxis(point.y),
  ...
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class, "QuadrantBuilder"), _Class);

  // src/diagrams/quadrant-chart/utils.ts
  var InvalidStyleError = (_Class2 = class InvalidStyleError extends Error {
    constructor(style, value, type) {
      super(`value for ${style} ${value} is invalid, please use a valid ${type}`);
      this.name = "InvalidStyleError";
    }
  }, (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(_Class2, "InvalidStyleError"), _Class2);
  function validateHexCode(value) {
    return !/^#?([\dA-Fa-f]{6}|[\dA-Fa-f]{3})$/.test(value);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(validateHexCode, "validateHexCode");
  function validateNumber(value) {
    return !/^\d+$/.test(value);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(validateNumber, "validateNumber");
  function validateSizeInPixels(value) {
    return !/^\d+px$/.test(value);
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(validateSizeInPixels, "validateSizeInPixels");

  // src/diagrams/quadrant-chart/quadrantDb.ts
  var config = (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").getConfig2)();
  function textSanitizer(text) {
    return (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").sanitizeText)(text.trim(), config);
  }
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setQuadrant1Text, "setQuadrant1Text");
  function setQuadrant2Text(textObj) {
    quadrantBuilder.setData({
      quadrant2Text: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setQuadrant2Text, "setQuadrant2Text");
  function setQuadrant3Text(textObj) {
    quadrantBuilder.setData({
      quadrant3Text: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setQuadrant3Text, "setQuadrant3Text");
  function setQuadrant4Text(textObj) {
    quadrantBuilder.setData({
      quadrant4Text: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setQuadrant4Text, "setQuadrant4Text");
  function setXAxisLeftText(textObj) {
    quadrantBuilder.setData({
      xAxisLeftText: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setXAxisLeftText, "setXAxisLeftText");
  function setXAxisRightText(textObj) {
    quadrantBuilder.setData({
      xAxisRightText: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setXAxisRightText, "setXAxisRightText");
  function setYAxisTopText(textObj) {
    quadrantBuilder.setData({
      yAxisTopText: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setYAxisTopText, "setYAxisTopText");
  function setYAxisBottomText(textObj) {
    quadrantBuilder.setData({
      yAxisBottomText: textSanitizer(textObj.text)
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setYAxisBottomText, "setYAxisBottomText");
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(parseStyles, "parseStyles");
  function addPoint(textObj, className, x, y, styles) {
    const stylesObject = parseStyles(styles);
    quadrantBuilder.addPoints([Object.assign({
      x,
      y,
  ...
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(addPoint, "addPoint");
  function addClass(className, styles) {
    quadrantBuilder.addClass(className, parseStyles(styles));
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(addClass, "addClass");
  function setWidth(width) {
    quadrantBuilder.setConfig({
      chartWidth: width
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setWidth, "setWidth");
  function setHeight(height) {
    quadrantBuilder.setConfig({
      chartHeight: height
    });
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(setHeight, "setHeight");
  function getQuadrantData() {
    const config2 = (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").getConfig2)();
    const {
      themeVariables,
    ...
    quadrantBuilder.setData({
      titleText: (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").getDiagramTitle)()
    });
    return quadrantBuilder.build();
  }
  (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getQuadrantData, "getQuadrantData");
  ...
  var draw = /* @__PURE__ */(0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)((txt, id, _version, diagObj) => {
    ...
    (0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(getTransformation, "getTransformation");
    const conf = (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").getConfig2)();
    require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").log.debug("Rendering quadrant chart\n" + txt);
    const securityLevel = conf.securityLevel;
    let sandboxElement;
    if (securityLevel === "sandbox") {
      sandboxElement = (0, require(_dependencyMap[2], "d3").select)("#i" + id);
    }
    const root = securityLevel === "sandbox" ? (0, require(_dependencyMap[2], "d3").select)(sandboxElement.nodes()[0].contentDocument.body) : (0, require(_dependencyMap[2], "d3").select)("body");
    const svg = root.select(`[id="${id}"]`);
    const group = svg.append("g").attr("class", "main");
    const width = conf.quadrantChart?.chartWidth ?? 500;
    const height = conf.quadrantChart?.chartHeight ?? 500;
    (0, require(_dependencyMap[1], "./chunk-ABZYJK2D.mjs").configureSvgSize)(svg, height, width, conf.quadrantChart?.useMaxWidth ?? true);
  ...
  var diagram = exports.diagram = {
    ...
    styles: /* @__PURE__ */(0, require(_dependencyMap[0], "./chunk-AGHRB4JF.mjs").__name)(() => "", "styles")
  };
},3862,[3854,3872,3884],"../../node_modules/mermaid/dist/chunks/mermaid.core/quadrantDiagram-AYHSOK5B.mjs");
...
//# debugId=ee1553bd-ddb8-404f-905a-971043049b12