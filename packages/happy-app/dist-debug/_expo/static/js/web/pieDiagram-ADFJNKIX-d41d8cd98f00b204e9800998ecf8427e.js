__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var DEFAULT_PIE_CONFIG = require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").defaultConfig_default.pie;
  var DEFAULT_PIE_DB = {
  ...
  var getConfig2 = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => structuredClone(config), "getConfig");
  ...
  var addSection = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(({
    label,
    value
  }) => {
    if (value < 0) {
    ...
    if (!sections.has(label)) {
      ...
      require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug(`added new section: ${label}, with value: ${value}`);
    }
  }, "addSection");
  var getSections = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => sections, "getSections");
  var setShowData = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(toggle => {
    showData = toggle;
  }, "setShowData");
  var getShowData = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(() => showData, "getShowData");
  var db = {
  ...
  // src/diagrams/pie/pieParser.ts
  var populateDb = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((ast, db2) => {
    (0, require(_dependencyMap[2], "./chunk-4BX2VUAB.mjs").populateCommonDb)(ast, db2);
    db2.setShowData(ast.showData);
    ast.sections.map(db2.addSection);
  }, "populateDb");
  var parser = {
    parse: /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(async input => {
      const ast = await (0, require(_dependencyMap[3], "@mermaid-js/parser").parse)("pie", input);
...
`, "getStyles");
  ...
  var createPieArcs = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)(sections2 => {
    ...
    const pie = (0, require(_dependencyMap[4], "d3").pie)().value(d => d.value);
    return pie(pieData);
  }, "createPieArcs");
  var draw = /* @__PURE__ */(0, require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").__name)((text, id, _version, diagObj) => {
    require(_dependencyMap[1], "./chunk-AGHRB4JF.mjs").log.debug("rendering pie chart\n" + text);
    const db2 = diagObj.db;
    const globalConfig = (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").getConfig2)();
    const pieConfig = (0, require(_dependencyMap[5], "./chunk-S3R3BYOJ.mjs").cleanAndMerge)(db2.getConfig(), globalConfig.pie);
    const MARGIN = 40;
    ...
    let [outerStrokeWidth] = (0, require(_dependencyMap[5], "./chunk-S3R3BYOJ.mjs").parseFontSize)(themeVariables.pieOuterStrokeWidth);
    outerStrokeWidth ??= 2;
    const textPosition = pieConfig.textPosition;
    const radius = Math.min(pieWidth, height) / 2 - MARGIN;
    const arcGenerator = (0, require(_dependencyMap[4], "d3").arc)().innerRadius(0).outerRadius(radius);
    const labelArcGenerator = (0, require(_dependencyMap[4], "d3").arc)().innerRadius(radius * textPosition).outerRadius(radius * textPosition);
    ...
    const color = (0, require(_dependencyMap[4], "d3").scaleOrdinal)(myGeneratedColors);
    ...
    (0, require(_dependencyMap[0], "./chunk-ABZYJK2D.mjs").configureSvgSize)(svg, height, totalWidth, pieConfig.useMaxWidth);
  }, "draw");
  var renderer = {
    draw
  };
...
},3861,[3872,3854,3916,3917,3884,3882,3871],"../../node_modules/mermaid/dist/chunks/mermaid.core/pieDiagram-ADFJNKIX.mjs");
...
//# debugId=59b15d93-3ad5-406f-8711-c1fc3e750010